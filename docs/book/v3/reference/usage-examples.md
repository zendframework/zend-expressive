...
Expressive works with [PSR-11 Containers](https://www.php-fig.org/psr/psr-11/),
though it's an optional feature. By default, if you use the `AppFactory`, it
will use [zend-servicemanager](https://docs.zendframework.com/zend-servicemanager/)
...
```php
$app->post('/post', function ($request, \Psr\Http\Server\RequestHandlerInterface $handler) {
